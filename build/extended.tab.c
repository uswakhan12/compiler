...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: expr '\n'  */
#line 30 "parser/extended.y"
              { printf("= %.6g\n", (yyvsp[-1].val)); }
#line 1093 "build/extended.tab.c"
    break;

  case 6: /* line: error '\n'  */
#line 32 "parser/extended.y"
                 { yyerrok; }
#line 1099 "build/extended.tab.c"
    break;

  case 7: /* expr: expr '+' expr  */
#line 36 "parser/extended.y"
                  { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val); }
#line 1105 "build/extended.tab.c"
    break;

  case 8: /* expr: expr '-' expr  */
#line 37 "parser/extended.y"
                    { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); }
#line 1111 "build/extended.tab.c"
    break;

  case 9: /* expr: expr '*' expr  */
#line 38 "parser/extended.y"
                    { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1117 "build/extended.tab.c"
    break;

  case 10: /* expr: expr '/' expr  */
#line 39 "parser/extended.y"
                    { (yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val); }
#line 1123 "build/extended.tab.c"
    break;

  case 11: /* expr: expr '^' expr  */
#line 40 "parser/extended.y"
                    { (yyval.val) = pow((yyvsp[-2].val), (yyvsp[0].val)); }
#line 1129 "build/extended.tab.c"
    break;

  case 12: /* expr: '(' expr ')'  */
#line 41 "parser/extended.y"
                    { (yyval.val) = (yyvsp[-1].val); }
#line 1135 "build/extended.tab.c"
    break;

  case 13: /* expr: LOG '(' expr ')'  */
#line 42 "parser/extended.y"
                       { (yyval.val) = log((yyvsp[-1].val)); }
#line 1141 "build/extended.tab.c"
    break;

  case 14: /* expr: EXP '(' expr ')'  */
#line 43 "parser/extended.y"
                       { (yyval.val) = exp((yyvsp[-1].val)); }
#line 1147 "build/extended.tab.c"
    break;

  case 15: /* expr: NUM  */
#line 44 "parser/extended.y"
          { (yyval.val) = (yyvsp[0].val); }
#line 1153 "build/extended.tab.c"
    break;


#line 1157 "build/extended.tab.c"
