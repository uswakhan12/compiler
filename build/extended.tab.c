...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "ID", "LOG",
  "EXP", "'+'", "'-'", "'*'", "'/'", "'^'", "'\\n'", "'='", "'('", "')'",
...
{
     -11,     0,   -11,   -10,   -11,     6,    -1,    25,   -11,     4,
     -11,    45,   -11,     4,     4,     4,   -11,    18,     4,     4,
       4,     4,     4,   -11,    51,    27,    36,   -11,    21,    21,
      29,    29,    29,   -11,   -11,   -11
};
...
{
       2,     0,     1,     0,    16,    17,     0,     0,     6,     0,
       3,     0,     7,     0,     0,     0,    17,     0,     0,     0,
       0,     0,     0,     4,     0,     0,     0,    13,     8,     9,
      10,    11,    12,     5,    14,    15
};
...
{
       2,     3,    12,     4,     5,     6,     7,     4,    16,     6,
       7,    17,     8,    14,     9,    24,    25,    26,     9,    13,
      28,    29,    30,    31,    32,    18,    19,    20,    21,    22,
      20,    21,    22,    27,    18,    19,    20,    21,    22,    15,
      22,     0,    34,    18,    19,    20,    21,    22,     0,     0,
       0,    35,    18,    19,    20,    21,    22,    23,    18,    19,
      20,    21,    22,    33
};

static const yytype_int8 yycheck[] =
{
       0,     1,    12,     3,     4,     5,     6,     3,     4,     5,
       6,     9,    12,    14,    14,    13,    14,    15,    14,    13,
      18,    19,    20,    21,    22,     7,     8,     9,    10,    11,
       9,    10,    11,    15,     7,     8,     9,    10,    11,    14,
      11,    -1,    15,     7,     8,     9,    10,    11,    -1,    -1,
      -1,    15,     7,     8,     9,    10,    11,    12,     7,     8,
       9,    10,    11,    12
};
...
{
       0,    17,     0,     1,     3,     4,     5,     6,    12,    14,
      18,    19,    12,    13,    14,    14,     4,    19,     7,     8,
       9,    10,    11,    12,    19,    19,    19,    15,    19,    19,
      19,    19,    19,    12,    15,    15
};
...
#line 1210 "build/extended.tab.c"
